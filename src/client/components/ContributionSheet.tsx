  ...
  return (
    <div className="sheet-backdrop">
      <section className="bottom-sheet contribution-sheet" role="dialog" aria-modal="true" aria-labelledby="contribution-title">
        ...
        <span className="selected-answer"><CheckCircle weight="fill" aria-hidden="true" />{choice}</span>
        ...
        <button type="button" className="primary-button" disabled={!text.trim() && !file} onClick={() => void onSubmit({ text, file })}>경험 보내고 10P 받기</button>
      </section>
    </div>
  );
}
